...
By changing the "OPTION" constant, at the beginning of the code, selecting 1 or 2, the program will assume the video file is already stored on the Server, or it will wait for the client to send it respectively.
